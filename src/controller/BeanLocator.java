...
public class BeanLocator 
{
	...
	private static final String EAR_NAME = "ApplicationPipe";
	private static final String EJB_JAR_NAME = "EJBPipe1";
...
//                + clz.getName());
        return (T) context.lookup("ejb:"+EJB_JAR_NAME+"/"+beanName+"!"
                + clz.getName());
	}
